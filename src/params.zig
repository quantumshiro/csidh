...
pub const pBits = 511;
pub const primeCount = 74;
pub const expMax = 5;
pub const limbBitsSize = 64;
pub const limbBytesSize = 8;
pub const numWords = 8;
pub const primeKeySize = 37;
pub const publicKeySize = 64;
pub const sharedSecretSize = 64;

// Elkies primes up to 374 + prime 587
// p = 4 * product(Elkies primes) - 1
pub var primes = [primeCount]u64{
...
// -p^-1 mod 2^64
var pNegativeInverse = fp.Fp{
    0x66c1301f632e294d, 0x0000000000000000,
    0x0000000000000000, 0x0000000000000000,
    0x0000000000000000, 0x0000000000000000,
    0x0000000000000000, 0x8000000000000000,
};

// (p-1)/2. Used as exponent, hence not in montgomery domain
var pMin1By2 = fp.Fp{
...
// p-1 mod 2^64. Used as exponent, hence not in montgomery domain
var pMin1 = fp.Fp{
